...
public class Packager {
    ...
    static UnityEngine.Object LoadAsset(string file) {
        ...
        UnityEngine.Debug.Log(AppConst.FrameworkRoot + "/Examples/Builds/" + file);

        return AssetDatabase.LoadMainAssetAtPath(AppConst.FrameworkRoot+"/Examples/Builds/" + file);
    }
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("prompt" + AppConst.ExtName, "*.prefab", "Assets/"+ AppConst.AppName+"/Examples/Builds/Prompt");
        AddBuildMap("message" + AppConst.ExtName, "*.prefab", "Assets/" + AppConst.AppName + "/Examples/Builds/Message");

        AddBuildMap("prompt_asset" + AppConst.ExtName, "*.png", "Assets/" + AppConst.AppName + "/Examples/Textures/Prompt");
        AddBuildMap("shared_asset" + AppConst.ExtName, "*.png", "Assets/" + AppConst.AppName + "/Examples/Textures/Shared");
    }
